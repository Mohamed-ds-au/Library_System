...
public class Sql {
	...
	public static void Connect() throws SQLException, ClassNotFoundException {
		...
		Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/library","root","mysql-passord");  
	...
	public static void searchBook(String name) throws SQLException {
		...
		Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/library","root","mysql-password");  
		Statement st=con.createStatement();
